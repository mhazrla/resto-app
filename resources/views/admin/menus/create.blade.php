            ...
            <div class="m-2 p-2">
                ...
                <form method="POST" action={{ route('admin.menus.store') }} enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            class="block p-2 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none  @error('price') border-red-400 @enderror"
                            placeholder="Rp500000" id="price" name="price" type="number">
                        @error('price')
                            <div class="text-sm text-red-600">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-6">
                        <label for="categories" class="block mb-2 text-sm font-medium text-gray-900 ">Select an
                            option</label>
